...
const AdminLogin = lazy(() => import("./admin/AdminPages").then(module => ({ default: module.AdminLogin })));
const NewPostPage = lazy(() => import("./admin/NewPostPage").then(module => ({ default: module.NewPostPage })));
const PreviewPage = lazy(() => import("./admin/NewPostPage").then(module => ({ default: module.PreviewPage })));
const TeamManagement = lazy(() => import("./admin/AdminManagement").then(module => ({ default: module.TeamManagement })));
const AnalyticsDashboard = lazy(() => import("./admin/AdminManagement").then(module => ({ default: module.AnalyticsDashboard })));

function Router() { return <Switch><Route path="/" component={Home} /><Route path="/archive" component={Archive} /><Route path="/post/:id" component={PostDetail} /><Route path="/how-it-works" component={HowItWorks} /><Route path="/help" component={HelpCenter} /><Route path="/contact" component={Contact} /><Route path="/privacy" component={() => <SupportPage kind="/privacy" />} /><Route path="/terms" component={() => <SupportPage kind="/terms" />} /><Route path="/login"><ReaderAuth mode="login" /></Route><Route path="/signup"><ReaderAuth mode="signup" /></Route><Route path="/forgot-password"><ReaderAuth mode="forgot" /></Route><Route path="/reset-password"><ReaderAuth mode="reset" /></Route><Route path="/verify-email"><ReaderAuth mode="verify" /></Route><Route path="/newsroom-7x" component={() => <><Seo title="Newsroom access — Aurikrex Bytes" description="Private Aurikrex Bytes newsroom access." path="/newsroom-7x" robots="noindex,nofollow" /><AdminLogin /></>} /><Route path="/admin" component={() => <><Seo title="Newsroom — Aurikrex Bytes" description="Private Aurikrex Bytes newsroom." path="/admin" robots="noindex,nofollow" /><AdminDashboard /></>} /><Route path="/admin/new" component={NewPostPage} /><Route path="/admin/new/:id" component={NewPostPage} /><Route path="/admin/preview/:draftId" component={PreviewPage} /><Route path="/admin/team" component={TeamManagement} /><Route path="/admin/analytics" component={AnalyticsDashboard} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
