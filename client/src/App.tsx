...
import { NewPostPage, PreviewPlaceholder } from "./admin/NewPostPage";

function Router() { return <Switch><Route path="/" component={Home} /><Route path="/login"><ReaderAuth mode="login" /></Route><Route path="/signup"><ReaderAuth mode="signup" /></Route><Route path="/forgot-password"><ReaderAuth mode="forgot" /></Route><Route path="/reset-password"><ReaderAuth mode="reset" /></Route><Route path="/verify-email"><ReaderAuth mode="verify" /></Route><Route path="/newsroom-7x" component={AdminLogin} /><Route path="/admin/new" component={NewPostPage} /><Route path="/admin/preview/:draftId" component={PreviewPlaceholder} /><Route path="/admin" component={AdminDashboard} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
